...
| `publish_plan_before_noisy_attempt_5.json` | `d69efe692b3fc68c0f4a1dc0dd2c3c2bce3430f6` | `cff22c4949e92ba884fad96c3962408f0dc498204269e59bfbe9bd27a86ca27b` | Schema-4 correctness, provenance, arithmetic, bounds, and all state-equality groups pass. Performance rejected after later host bursts: six first-publish, four steady, and three end-to-end rows exceed 10% RSD. Rotated run 7 contains the clearest retained/raw/sparse slowdown; no row is a comparison baseline. |
