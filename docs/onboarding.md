...
2. Run [examples/simple_latest.py](../examples/simple_latest.py) with
   `uv run python examples/simple_latest.py` to see publish/read-back.
3. Run [examples/rate_matched_sensor.py](../examples/rate_matched_sensor.py)
   with `uv run python examples/rate_matched_sensor.py` to see explicit demand.
