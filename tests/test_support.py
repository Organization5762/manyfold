...
def load_manyfold_package():
    ...
    exports = {
        ...
        "StreamMaterializationSettings": graph.StreamMaterializationSettings,
        "StreamMaterializationStrategy": graph.StreamMaterializationStrategy,
        "stream_from": graph.stream_from,
        ...
        "materialize_stream": graph.materialize_stream,
